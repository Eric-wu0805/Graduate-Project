...
import pickle
import joblib
from sklearn.metrics import accuracy_score, precision_score, recall_score, f1_score, roc_curve, auc, confusion_matrix, matthews_corrcoef
...
def main():
    ...
    try:
        ...
        #cross_df = pd.read_csv('kdd_test.csv')
    ...
    mcc = matthews_corrcoef(y_cross, final_preds)
    ...
    print(f"Cross-Dataset MCC:       {mcc:.4f}")
