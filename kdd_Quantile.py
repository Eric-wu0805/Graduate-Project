...
def preprocess_data(df, numerical_cols, categorical_cols, scalers, label_encoders, selected_features, final_scaler):
    ...
    for col in numerical_cols:
        # Use QuantileTransformer from the scalers dictionary
    ...
    # Final standardization with QuantileTransformer
...
# Modified preprocess_data_aclr_style function
...
def main():
    ...
    scalers = joblib.load('feature_scalers.pkl')  # Must contain QuantileTransformer objects
    label_encoders = joblib.load('label_encoders.pkl')
    selected_features = joblib.load('selected_features.pkl')
    final_scaler = joblib.load('final_scaler.pkl')  # Must be QuantileTransformer
    with open('model_config.pkl', 'rb') as f:
        model_config = pickle.load(f)
    final_meta_model = joblib.load('final_meta_model.pkl')  # XGBoost or RF
